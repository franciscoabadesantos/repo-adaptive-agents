...
def render(role: CanonicalRole) -> RenderedTarget:
    ...
    return RenderedTarget(
        ...
        semantic_mapping={
            ...
            "purpose+procedure+constraints+evidence_requirements": "developer_instructions",
        ...
        warnings=(
            "This wrapper does not modify .codex/config.toml; register the agent there to enable it.",
        ),
    )
